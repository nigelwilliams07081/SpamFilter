...
# Flexible version
bsub -n 4 -R "span[ptile=1]" -o %J.txt  "/opt/ibm/platform_mpi/bin/mpirun -entry=manual:mtdlib -lsf -vapi $PWD/SpamFilter -inputfile $PWD/stress.xml -outputfile $PWD/stress_output.xml -threads 10"